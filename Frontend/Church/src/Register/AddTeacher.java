...
public class AddTeacher extends javax.swing.JFrame {
    ...
    private void btnRegisterActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRegisterActionPerformed
        new AddTeacher().callProcedure("spAddTeacher",firstNameTF.getText(),lastNumberTF.getText(),phoneNumberTF.getText(),emailTF.getText(),townTF.getText(),officeRoomNumberTF.getText(),genderTF.getText(),idNumberTF.getText());
